<section class="w-full" >
 <div class="relative h-screen bg-cover bg-center" style="background-image: url('<?= base_url() ?>public/images/contactoMachupichu.jpg');">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full text-white text-center p-5">
        <h1 class="font-bold mb-4 titleWeb">Cocina de Nancy</h1>
...
<section class="w-full fontParagraph" >
    ...
    <div class="flex-1 md:w-50 hidden lg:block p-12 lg:p-auto lg:mx-0 lg:my-auto bg-white">
        ...
        <strong>
            <p class="lg:hidden mb-5 textTitle">Cocina de Nancy</p></strong>
...
<section class="w-full fontParagraph">
    <div class="relative sm:h-screen flex flex-col sm:flex-row">
        ...
        <div class="flex-1 bg-contain sm:bg-cover bg-center relative" style="background-image: url('<?= base_url() ?>public/images/alfajores.jpg');">
            <div class="sm:absolute inset-0 bg-black opacity-40"></div>
            <div class="sm:absolute bottom-0 left-0 w-full p-6 sm:text-white z-10">
                ...
                <a href="productos" class="bg-red-600 hover:bg-red-700 text-white sm:text-2xl font-semibold py-2 px-4 rounded-lg">Ver Productos</a>
            </div>
        </div>
        <div class="flex-1 bg-contain sm:bg-cover bg-center relative" style="background-image: url('<?= base_url() ?>public/images/alfajores.jpg');">
            <div class="sm:absolute inset-0 bg-black opacity-40"></div>
            <div class="sm:absolute bottom-0 left-0 w-full p-6 sm:text-white z-10">
                ...
                <a href="contacto" class="bg-red-600 hover:bg-red-700 text-white sm:text-2xl font-semibold py-2 px-4 rounded-lg">Contacto</a>
            </div>
        </div>
    </div>
</section>
