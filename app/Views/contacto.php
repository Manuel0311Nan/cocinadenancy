...
<div class="flex flex-col sm:flex-row items-center p-2 sm:p-10 ">
    ...
    <article class="w-full sm:w-1/2 ">
        <form action="<?= base_url()?>envioform" class="space-y-5">
        <h2 class="text-center text-3xl font-bold text-gray-900">Contáctanos</h2>
        <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre</label>
                <input type="text" id="name" class="bg-gray-50 border border-red-800 text-sm rounded-lg focus:border-red-800 focus:border-red-500 block w-full p-4" placeholder="Nombre Completo" required />
            </div>
            <div>
