...
<header class="bg-red-700">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-red-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-white">
      ...
      <li>
        <a href="productos" class="block my-2 mx-1 p-2 rounded-md transition-all text-2xl hover:bg-red-700 hover:text-white text-red-700 font-bold text-center">Productos</a>
      </li>
      <li>
        <a href="#" class="block my-2 p-2 rounded-md transition-all text-2xl hover:bg-red-700 hover:text-white text-red-700 font-bold text-center">Sobre nosotros</a>
      </li>
      <li>
        <a href="contacto" class="block my-2 mx-1 p-2 rounded-md transition-all text-2xl hover:bg-red-700 hover:text-white text-red-700 font-bold text-center">Contacto</a>
      </li>
    </ul>
  </div>
  </div>
